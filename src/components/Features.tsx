...
const features = [
    ...
    {
        icon: <Home size={24} color="var(--primary)" />,
    ...
    {
        icon: <FolderCheck size={24} color="var(--primary)" />,
...
const Features = () => {
    return (
        <section id="features" style={{ backgroundColor: 'var(--muted)' }}>
            <div className="container">
                <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
                    <h2 style={{ fontSize: 'clamp(2rem, 5vw, 2.5rem)', marginBottom: '1rem' }}>Everything you need to succeed</h2>
                    <p style={{ color: 'var(--secondary)', fontSize: 'clamp(1rem, 3vw, 1.125rem)', maxWidth: '700px', margin: '0 auto' }}>
                ...
                <div className="grid grid-2 grid-3">
                    {features.map((feature, index) => (
                        ...
                        >
                            ...
                            <p style={{ color: 'var(--secondary)', fontSize: '0.9375rem' }}>{feature.description}</p>
                        </motion.div>
                    ))}
                </div>
            </div>
